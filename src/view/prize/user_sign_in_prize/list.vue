...
<script>
        import {getDataList,coruData} from '@/api/user_sign_in_prize_list'
    ...
    export default {
        ...
        data() {
            return {
                                // 初始化表格列
                columnsList:[{title:'用户id',key:'user_id',align:'center'},{title:'签到奖品id',key:'sign_in_prize_id',align:'center'},{title:'日期',key:'date',align:'center'},{title:'创建日期',key:'gmt_create',align:'center'}],
                // 表格数据
                tableData: [],
                // 表格显示分页属性
                tableShow: {

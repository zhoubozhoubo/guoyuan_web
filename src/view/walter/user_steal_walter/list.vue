...
<script>
        import {getDataList,coruData} from '@/api/user_steal_walter_list'
    ...
    export default {
        ...
        data() {
            return {
                                // 初始化表格列
                columnsList:[{title:'对象用户-发放水滴id',key:'user_grant_walter_id',align:'center'},{title:'用户id',key:'user_id',align:'center'},{title:'对象用户id',key:'from_user_id',align:'center'},{title:'类型',key:'type',align:'center'},{title:'日期',key:'date',align:'center'},{title:'创建日期',key:'gmt_create',align:'center'}],
                // 表格数据
                tableData: [],
                // 表格显示分页属性
                tableShow: {

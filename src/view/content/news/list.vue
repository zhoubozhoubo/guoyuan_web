    ...
    <Modal v-model="modalSetting.show" width="700" :styles="{top: '30px'}" @on-visible-change="doCancel">
      ...
      <Form ref="myForm" :rules="ruleValidate" :model="formItem" :label-width="100">
        ...
        <FormItem label="时间" prop="time">
          <TimePicker type="time" @on-change="formItem.time=$event" :value="formItem.time" placeholder="选择时间"
...
<script>
  ...
  import {getDataList, coruData} from '@/api/news_list'
  // 编辑
    ...
    data() {
      return {
        ...
        columnsList: [{title: '新闻标题', key: 'title', align: 'center'}, {
          ...
          key: 'device',
          align: 'center'
        }, {title: '时间', key: 'time', align: 'center'}, {title: '状态', key: 'status', align: 'center'}, {
          title: '操作',
          key: 'handle',
          align: 'center',
          handle: ['edit', 'delete']
        ...
        // 搜索配置
        searchConf: {title: '', author: '', date: '', device: '', status: ''},
        // 表单属性
        formItem: {
          id: '',
          title: '',

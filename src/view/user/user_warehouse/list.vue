...
<script>
  import {getDataList, coruData} from '@/api/user_warehouse_list'
  ...
  export default {
    ...
    data() {
      return {
        // 初始化表格列
        columnsList: [{title: '水滴数', key: 'walter_number', align: 'center'}, {
          title: '小化肥数',
          key: 'little_fertilizer_number',
          align: 'center'
        }, {title: '大化肥数', key: 'big_fertilizer_number', align: 'center'}, {
          title: '钻石数',
          key: 'diamond_number',
          align: 'center'
        }],
